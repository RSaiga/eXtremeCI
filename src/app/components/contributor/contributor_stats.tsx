          ...
          <Card>
            <CardContent>
              ...
              <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
                <Typography variant="h4" color={top3CommitShare > 80 ? 'error' : top3CommitShare > 60 ? 'warning.main' : 'success.main'}>
        ...
        <Grid xs={3}>
          <Card>
            <CardContent>
              ...
              <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
                <Typography variant="h4" color={top3CodeShare > 80 ? 'error' : top3CodeShare > 60 ? 'warning.main' : 'success.main'}>
